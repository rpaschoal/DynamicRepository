...
namespace DynamicRepository.Mapping
{
    ...
    /// </summary>
    /// <example>
    /// [PagedDataAdapter("MyProperty", "CustomFilterForProperty", InMemoryPath = "Items.PropertyOne|Items.PropertyTwo")]
    /// 
    ...
    /// * Second parameter indicates how API names the property (Can be the name of the property on the entity, or a custom name setting IF using ExtraPagedDataFilters);
    ...
    public sealed class PagedDataAdapterAttribute : Attribute
    {
        public PagedDataAdapterAttribute(string propFrom, string mapsTo, string inMemoryPath = "")
        {
